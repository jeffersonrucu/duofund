...
<div class="max-w-4xl mx-auto" x-data="{ mobileMenuOpen: false, section: 'intro' }">
    {{-- HEADER --}}
    <div class="mb-8">
        <div class="flex items-center gap-3 mb-2">
            <div class="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center">
                <x-lucide-book-open class="w-6 h-6 text-primary" />
            </div>
            <div>
    ...
    @php
        $sections = [
            ...
            'budget'       => ['icon' => 'tags',             'label' => 'Categorias'],
    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="lg:hidden">
            <button @click="mobileMenuOpen = !mobileMenuOpen" class="w-full flex items-center justify-between bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
                ...
                <x-lucide-chevron-down class="w-5 h-5 text-gray-400" ::class="mobileMenuOpen && 'rotate-180'" style="transition: transform 0.2s" />
            </button>
            <div x-show="mobileMenuOpen" x-collapse class="mt-2 bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                @foreach($sections as $key => $item)
                    <button @click="section = '{{ $key }}'; mobileMenuOpen = false"
                        class="w-full flex items-center gap-3 p-3 text-left hover:bg-gray-50 transition"
                        :class="section === '{{ $key }}' ? 'bg-primary/5 text-primary border-l-2 border-primary' : 'text-gray-600'">
            ...
            <nav class="bg-white rounded-xl border border-gray-200 shadow-sm p-2 sticky top-24">
                ...
                @foreach($sections as $key => $item)
                    <button @click="section = '{{ $key }}'"
                        ...
                        :class="section === '{{ $key }}' ? 'bg-primary text-white shadow-md' : 'text-gray-600 hover:bg-gray-50'">
                        <x-dynamic-component :component="'lucide-'.($item['icon'])" class="w-4 h-4" />
                        <span class="text-sm font-medium">{{ $item['label'] }}</span>
                    </button>
                @endforeach
        ...
        <main class="flex-1 min-w-0">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                <div class="bg-gradient-to-r from-primary to-blue-600 p-6 text-white">
                    <h2 class="text-xl font-bold flex items-center gap-2">
                        <x-lucide-rocket class="w-6 h-6" /> Bem-vindo ao DuoFund!
                    </h2>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="bg-amber-50 border border-amber-200 rounded-xl p-4">
                        <div class="flex gap-3">
                            <x-lucide-lightbulb class="w-5 h-5 text-amber-600 flex-shrink-0 mt-0.5" />
                            <div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                <div class="bg-gradient-to-r from-gray-800 to-gray-900 p-6 text-white">
                    <h2 class="text-xl font-bold flex items-center gap-2">
                        <x-lucide-layout-dashboard class="w-6 h-6" /> Painel Principal
                    </h2>
                ...
                <div class="p-6 space-y-6">
                    <div class="space-y-4">
                        <h3 class="font-bold text-gray-900 flex items-center gap-2">
                            <x-lucide-toggle-left class="w-5 h-5 text-primary" /> Alternador de Visão
                        </h3>
                        ...
                        <div class="grid sm:grid-cols-2 gap-3">
                            ...
                            <div class="p-3 bg-purple-50 rounded-lg border border-purple-100">
                                <div class="flex items-center gap-2 mb-1">
                                    <x-lucide-users class="w-4 h-4 text-purple-600" />
                    ...
                    <div class="space-y-4">
                        <h3 class="font-bold text-gray-900 flex items-center gap-2">
                            <x-lucide-credit-card class="w-5 h-5 text-primary" /> Cards de Resumo
                        </h3>
                        <div class="space-y-3">
                    ...
                    <div class="space-y-4">
                        <h3 class="font-bold text-gray-900 flex items-center gap-2">
                            <x-lucide-calendar class="w-5 h-5 text-primary" /> Navegação de Mês
                        </h3>
                        <p class="text-gray-600 text-sm">
            ...
            {{-- TRANSAÇÕES --}}
            <div x-show="section === 'transactions'" x-cloak>
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                <div class="bg-gradient-to-r from-indigo-600 to-purple-600 p-6 text-white">
                    <h2 class="text-xl font-bold flex items-center gap-2">
                        <x-lucide-arrow-left-right class="w-6 h-6" /> Transações
                    </h2>
                ...
                <div class="p-6 space-y-6">
                        ...
                        <div class="grid sm:grid-cols-2 gap-3">
                            <div class="p-4 bg-green-50 rounded-xl border border-green-100">
                                <div class="flex items-center gap-2 mb-2">
                                    <x-lucide-arrow-up class="w-5 h-5 text-green-600" />
                            ...
                            <div class="p-4 bg-red-50 rounded-xl border border-red-100">
                                <div class="flex items-center gap-2 mb-2">
                                    <x-lucide-arrow-down class="w-5 h-5 text-red-600" />
                            ...
                            <div class="p-3 bg-blue-50 rounded-lg border border-blue-100">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="px-2 py-0.5 bg-blue-100 text-blue-700 rounded text-xs font-bold">
                                        <x-lucide-repeat class="w-3 h-3 inline" />
                                    </span>
                                </div>
                    ...
                    <div class="bg-violet-50 border border-violet-200 rounded-xl p-4">
                        <div class="flex gap-3">
                            <x-lucide-arrow-right-left class="w-5 h-5 text-violet-600 flex-shrink-0 mt-0.5" />
                            <div>
            ...
            {{-- PARCELAS --}}
            <div x-show="section === 'installments'" x-cloak>
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                <div class="bg-gradient-to-r from-yellow-500 to-amber-600 p-6 text-white">
                    <h2 class="text-xl font-bold flex items-center gap-2">
                        <x-lucide-credit-card class="w-6 h-6" /> Parcelas
                    </h2>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="bg-amber-50 border border-amber-200 rounded-xl p-4">
                        <div class="flex gap-3">
                            <x-lucide-plus-circle class="w-5 h-5 text-amber-600 flex-shrink-0 mt-0.5" />
            ...
            {{-- ORÇAMENTO --}}
            <div x-show="section === 'budget'" x-cloak>
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                <div class="bg-gradient-to-r from-emerald-600 to-teal-600 p-6 text-white">
                    <h2 class="text-xl font-bold flex items-center gap-2">
                        <x-lucide-tags class="w-6 h-6" /> Categorias
                    </h2>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="bg-green-50 border border-green-200 rounded-xl p-4">
                            <div class="flex gap-3">
                                <x-lucide-piggy-bank class="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                <div class="bg-gradient-to-r from-pink-500 to-rose-500 p-6 text-white">
                    <h2 class="text-xl font-bold flex items-center gap-2">
                        <x-lucide-gift class="w-6 h-6" /> Desejos
                    </h2>
            ...
            {{-- RELATÓRIO --}}
            <div x-show="section === 'report'" x-cloak>
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                <div class="bg-gradient-to-r from-slate-600 to-gray-800 p-6 text-white">
                    <h2 class="text-xl font-bold flex items-center gap-2">
                        <x-lucide-bar-chart-3 class="w-6 h-6" /> Relatório
                    </h2>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
                        <div class="flex gap-3">
                            <x-lucide-printer class="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" />
                            <div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                <div class="bg-gradient-to-r from-violet-600 to-purple-600 p-6 text-white">
                    <h2 class="text-xl font-bold flex items-center gap-2">
                        <x-lucide-users class="w-6 h-6" /> Finanças a Dois
                    </h2>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="bg-amber-50 border border-amber-200 rounded-xl p-4">
                        <div class="flex gap-3">
                            <x-lucide-clock class="w-5 h-5 text-amber-600 flex-shrink-0 mt-0.5" />
                            <p class="text-sm text-amber-800">
            ...
            {{-- DICAS ÚTEIS --}}
            <div x-show="section === 'tips'" x-cloak>
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                <div class="bg-gradient-to-r from-amber-500 to-orange-500 p-6 text-white">
                    <h2 class="text-xl font-bold flex items-center gap-2">
                        <x-lucide-lightbulb class="w-6 h-6" /> Dicas Úteis
                    </h2>
                ...
                <div class="p-6 space-y-6">
                    <div class="space-y-4">
                        <div class="p-4 bg-gradient-to-r from-blue-50 to-white rounded-xl border border-blue-100">
                            <div class="flex gap-3">
                                <div class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center flex-shrink-0">
                                    <x-lucide-smartphone class="w-5 h-5 text-blue-600" />
                                </div>
                                <div>
                        ...
                        <div class="p-4 bg-gradient-to-r from-green-50 to-white rounded-xl border border-green-100">
                            <div class="flex gap-3">
                                <div class="w-10 h-10 bg-green-100 rounded-lg flex items-center justify-center flex-shrink-0">
                                    <x-lucide-repeat class="w-5 h-5 text-green-600" />
                                </div>
                                <div>
                        ...
                        <div class="p-4 bg-gradient-to-r from-purple-50 to-white rounded-xl border border-purple-100">
                            <div class="flex gap-3">
                                <div class="w-10 h-10 bg-purple-100 rounded-lg flex items-center justify-center flex-shrink-0">
                                    <x-lucide-message-circle class="w-5 h-5 text-purple-600" />
                                </div>
                                <div>
                        ...
                        <div class="p-4 bg-gradient-to-r from-amber-50 to-white rounded-xl border border-amber-100">
                            <div class="flex gap-3">
                                <div class="w-10 h-10 bg-amber-100 rounded-lg flex items-center justify-center flex-shrink-0">
                                    <x-lucide-target class="w-5 h-5 text-amber-600" />
                                </div>
                                <div>
            ...
            <div class="mt-6 lg:hidden">
                <a href="{{ route('dashboard') }}" wire:navigate class="flex items-center justify-center gap-2 w-full py-3 bg-gray-100 text-gray-700 rounded-xl font-medium hover:bg-gray-200 transition">
                    <x-lucide-arrow-left class="w-4 h-4" /> Voltar ao Painel
                </a>
            </div>
        </main>
    </div>
